        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="body-large text-muted-foreground mb-6">
              At Royal Touch, grooming is a craft — not a routine. We believe every man 
              deserves to look and feel his absolute best.
            </p>
            <p className="text-muted-foreground font-sans leading-relaxed mb-8">
              Our team of certified, trained barbers combines traditional techniques with 
              modern styling expertise. We exclusively use premium L'Oréal and salon-grade 
            ...
            <div className="aspect-[4/5] bg-gradient-card rounded-sm border border-border/50 overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <h3 className="font-serif text-2xl mb-3">Excellence in Every Detail</h3>
                  <p className="text-muted-foreground text-sm max-w-xs mx-auto">
                    From the moment you walk in to the final touch, 
